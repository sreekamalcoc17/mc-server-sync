...
function Sidebar({ currentPage, onNavigate, disabled }: SidebarProps) {
    return (
        <aside className={`sidebar ${disabled ? 'sidebar-disabled' : ''}`}>
            <nav className="sidebar-nav">
                ...
                <button
                    className={`sidebar-item ${currentPage === 'server-config' ? 'active' : ''}`}
                    onClick={() => onNavigate('server-config')}
                    disabled={disabled}
                >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <button
                    className={`sidebar-item ${currentPage === 'mods' ? 'active' : ''}`}
